...
const RecipeItem = ({ item }) => {
  return (
    <div className="flex flex-col w-80 overflow-hidden p-5 bg-white/75 shadow-xl gap-5 border-2 rounded-2xl border-gray-500">
      ...
      <div>
        ...
        <Link
          to={`/food-recipe/recipe-item/${item?.id}`}
